...
The use of the algorithm's building blocks is explained as well. The well-known training data for the cereal market from -@Nevo2001 is used for demonstration purposes. Loading the package is the very first step of the demand estimation:
